<footer class="bg-gray-800 text-white py-8 mt-auto">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <h3 class="text-lg font-semibold mb-4">WebOPD</h3>
                <p class="text-gray-300 mb-4">Portal resmi Organisasi Perangkat Daerah yang menyediakan informasi dan layanan publik.</p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-gray-300 hover:text-white">Perizinan Online</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white">Pengaduan Masyarakat</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white">Informasi Publik</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white">Agenda Kegiatan</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white">Unduhan</a></li>
                </ul>
            </div>
            <div>
                ...
                <ul class="space-y-2 text-gray-300">
                    ...
                    <li class="flex items-start">
                        ...
                        <span>info@webopd.example.com</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="h-5 w-5 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="border-t border-gray-700 mt-8 pt-6 text-sm text-gray-400">
            <p>© {{ date('Y') }} WebOPD. Hak Cipta Dilindungi.</p>
        </div>
    </div>
</footer>